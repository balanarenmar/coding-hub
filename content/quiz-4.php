...
<body class="background-img-1 container box-layout">
    <!-- [ Pre-loader ] start -->
    <div class="loader-bg">
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                ...
                <div class="col-sm-12">
                    <div class="card widget-statstic-card">
                        <div class="card-header">
                            <h4 style="color: #FC3;">QUIZ # 4 </h4>
                        </div>
                        <div class="card-body">
                            <p class="f-16">Test your knowledge about what you've learned in the past lessons of Chapter 4.</p>
                            <p class="f-16">The quiz contains 20 questions and there is no time limit.</p>
                            <p class="f-16">Topics included in this quiz focus about C Functions and Recursion.</p>
            ...
            <!-- [ Main Content ] end -->
            <!-- [ Main Content ] start -->
            <form action="quiz-4-result.php" method="post" id="quiz">
                <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">_____ is the standard library for the C programming language.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required/>
                                        <label for="question-1-answers-A"><li>C++ Library Fumctions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                                        <label for="question-1-answers-B"><li>C Library Functions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                                        <label for="question-1-answers-C"><li>Universal Library Funtions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" />
                                        <label for="question-1-answers-D"><li>User Defined Functions for C</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Which of these are one of the advantages of using C library functions.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-A" value="A" required/>
                                        <label for="question-2-answers-A"><li>It saves considerable development time </li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
                                        <label for="question-2-answers-B"><li>It makes your code understandable </li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                                        <label for="question-2-answers-C"><li>Adds more aesthetics</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-D" value="D" />
                                        <label for="question-2-answers-D"><li>Makes the programmer look smart</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What does sqrt() library function do?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-A" value="A" required/>
                                        <label for="question-3-answers-A"><li>Gets the average</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                                        <label for="question-3-answers-B"><li>Gets the square</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                                        <label for="question-3-answers-C"><li>Gets the qoutient</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-D" value="D" />
                                        <label for="question-3-answers-D"><li>Gets the square root</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What will be the printed output of this code if the user inputs 12?</p>
                                ...
                                <ol class="choices">
                                    <div class="choice">
                                        ...
                                        <label for="question-4-answers-A"><li> 4</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-B" value="B" />
                                        <label for="question-4-answers-B"><li>3</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
                                        <label for="question-4-answers-C"><li>3.41</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-D" value="D" />
                                        <label for="question-4-answers-D"><li>.41</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">C allows you to define functions according to your need. These functions are known as?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-A" value="A" required/>
                                        <label for="question-5-answers-A"><li>user-defined functions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                                        <label for="question-5-answers-B"><li>user-library functions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                                        <label for="question-5-answers-C"><li>universal functions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-D" value="D" />
                                        <label for="question-5-answers-D"><li>free-flow functions</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">This type of function is simply the declaration of a function that specifies function's name, parameters and return type. It doesn't contain function body and it gives information to the compiler that the function may later be used in the program.</p>

                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-A" value="A" required/>
                                        <label for="question-6-answers-A"><li>universal function</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-B" value="B" />
                                        <label for="question-6-answers-B"><li>function prototype</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-C" value="C" />
                                        <label for="question-6-answers-C"><li>free-flow function</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-D" value="D" />
                                        <label for="question-6-answers-D"><li>free function</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Can a user-defined function have no arguments passed and return value?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-A" value="A" required/>
                                        <label for="question-7-answers-A"><li>No</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                                        <label for="question-7-answers-B"><li>Maybe</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" />
                                        <label for="question-7-answers-C"><li>Yes</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-D" value="D" />
                                        <label for="question-7-answers-D"><li>I don't know</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">How about, no arguments passed but there's a return value?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-A" value="A" required/>
                                        <label for="question-8-answers-A"><li>Still no</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                                        <label for="question-8-answers-B"><li>Maybe</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                                        <label for="question-8-answers-C"><li>I don't really know</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-D" value="D" />
                                        <label for="question-8-answers-D"><li>Yes</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">How about, argument passed but no return value?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-A" value="A" required/>
                                        <label for="question-9-answers-A"><li>Maybe</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                                        <label for="question-9-answers-B"><li>No</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" />
                                        <label for="question-9-answers-C"><li>Yes</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-D" value="D" />
                                        <label for="question-9-answers-D"><li>hmm, maybe</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Lastly, how about, argument passed and has a return value?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-A" value="A" required/>
                                        <label for="question-10-answers-A"><li>NO</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-B" value="B" />
                                        <label for="question-10-answers-B"><li>I don't know</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-C" value="C" />
                                        <label for="question-10-answers-C"><li>Maybe</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-D" value="D" />
                                        <label for="question-10-answers-D"><li>YES</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
           ...
           <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Is there something wrong with the code?</p>
                                ...
                                <ol class="choices">
                                    <div class="choice">
                                        ...
                                        <label for="question-11-answers-A"><li> No</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-11-answers" id="question-11-answers-B" value="B" />
                                        <label for="question-11-answers-B"><li>Yes</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What is the allocated memory size (in bytes) when storing the data type double?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-12-answers" id="question-12-answers-A" value="A" required/>
                                        <label for="question-12-answers-A"><li> 6</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-12-answers" id="question-12-answers-B" value="B" />
                                        <label for="question-12-answers-B"><li> at least 2, usually 4</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-12-answers" id="question-12-answers-C" value="C" />
                                        <label for="question-12-answers-C"><li> at least 10, usually 12 or 16</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-12-answers" id="question-12-answers-D" value="D" />
                                        <label for="question-12-answers-D"><li> 8</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What is the Output if the input is 3?</p>
                                        <div class="row text-center">
                                        <div class="col-sm-12">
                                            <img src="assets/images/video-lesson/snnur.jpg" alt="recursion img" width="100%" height="auto" style="max-width: 600px;">
                                            <br><br>
                                        </div>
                                    </div>
                                <ol class="choices">
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Advantages of Recursion?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-15-answers" id="question-15-answers-A" value="A" required/>
                                        <label for="question-15-answers-A"><li>makes the code complicated</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-15-answers" id="question-15-answers-B" value="B" />
                                        <label for="question-15-answers-B"><li>makes program elegant</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-15-answers" id="question-15-answers-C" value="C" />
                                        <label for="question-15-answers-C"><li>makes programmer to google how it works</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-15-answers" id="question-15-answers-D" value="D" />
                                        <label for="question-15-answers-D"><li>makes the code understandable to non-programmers</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What will be the output?</p>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">____ were supposed to be faster than local variables.</p>

                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-A" value="A" required/>
                                        <label for="question-18-answers-A"><li> Recursion Function</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-B" value="B" />
                                        <label for="question-18-answers-B"><li> Register Variable</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-C" value="C" />
                                        <label for="question-18-answers-C"><li>Standard Library Functions</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-D" value="D" />
                                        <label for="question-18-answers-D"><li>Static Variable</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">4 types of storage class</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-A" value="A" required/>
                                        <label for="question-20-answers-A"><li> external, disc, analog, digital </li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-B" value="B" />
                                        <label for="question-20-answers-B"><li> internal, external, analog, disc</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-C" value="C" />
                                        <label for="question-20-answers-C"><li> internal, external, analog, digital</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-D" value="D" />
                                        <label for="question-20-answers-D"><li> automatic, external, static, register</sup></li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
