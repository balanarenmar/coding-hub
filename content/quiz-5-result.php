...
require_once 'quiz-5-answersheet.php';
if(isset($answer1)){
    //proceed
    }else{
                    ...
                    <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-end">
                                <li class="page-item text-left m-r-50">
                                    <a class="page-link" href="5-arrays.php" tabindex="-1">Back to Chapter 5</a>
                                </li>
                                ...
                                <li class="page-item text-right">
                                    <a class="page-link" href="6-strings.php">Begin Chapter 6</a>
                                </li>
                            </ul>           
                    </nav>
                </footer>
