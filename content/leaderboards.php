...
require_once 'assets/quiz/db-connect.php'; 
?>
...
<head>
    <title>{C} - QUIZ LEADERBOARDS</title>
    <meta charset="utf-8">
...
<body class="background-img-4 container box-layout">
    ...
    <div class="pcoded-main-container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">QUIZ LEADERBOARDS</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#!"><i class="fas fa-trophy"></i></a></li>
                                <li class="breadcrumb-item"><a href="leaderboards.php">Overall Rankings</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        ...
                        <h3 class="yellow-head ">Quiz 1</h3>
                        <h1>Leaderboards</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard1" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_1");
        ...
        <!-- Quiz 1 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 2 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                    ...
                    <div class="card-body">
                        ...
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard2" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
        ...
        <!-- Quiz 2 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 3 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        <h3 class="yellow-head ">Quiz 3</h3>
                        <h1>Leaderboards</h1>
                    </div>
                    <div class="card-body">
                        <i class="fas fa-medal"></i> 
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard3" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_3");
                                        while($row = mysqli_fetch_array($result))
                                        {
                                        if($row['id'] == $_SESSION['id']){
                                        echo '<tr class="table-active">';
        ...
        <!-- Quiz 3 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 4 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        <h3 class="yellow-head ">Quiz 4</h3>
                        <h1>Leaderboards</h1>
                    </div>
                    <div class="card-body">
                        <i class="fas fa-award"></i>
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard4" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_4");
                                        while($row = mysqli_fetch_array($result))
                                        {
                                        if($row['id'] == $_SESSION['id']){
                                        echo '<tr class="table-active">';
        ...
        <!-- Quiz 4 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 5 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        <h3 class="yellow-head ">Quiz 5</h3>
                        <h1>Leaderboards</h1>
                    </div>
                    <div class="card-body">
                        <i class="fas fa-medal"></i> 
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard5" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_5");
                                        while($row = mysqli_fetch_array($result))
                                        {
                                        if($row['id'] == $_SESSION['id']){
                                        echo '<tr class="table-active">';
        ...
        <!-- Quiz 5 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 6 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto">
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        <h3 class="yellow-head ">Quiz 6</h3>
                        <h1>Leaderboards</h1>
                    </div>
                    <div class="card-body">
                        <i class="feather icon-award"></i>
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard6" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_6");
                                        while($row = mysqli_fetch_array($result))
                                        {
                                        if($row['id'] == $_SESSION['id']){
                                        echo '<tr class="table-active">';
        ...
        <!-- Quiz 6 Leaderboard end -->

        <hr style="border-color: white;">
           
        <!-- Quiz 7 Leaderboard start -->
        <div class="row text-center">
            <div class="col-sm-10 mx-auto" >
                <div class="card widget-visitor-card">
                    <div class="card-header conf-head btn">
                        <h3 class="yellow-head ">Quiz 7</h3>
                        <h1>Leaderboards</h1>
                    </div>
                    <div class="card-body">
                        <i class="fas fa-medal"></i> 
                        <div class="dt-responsive table-responsive ">
                            <table id="leaderboard7" class="table table-hover table-bordered nowrap text-center table-hover table-dark" >
                                <thead>
                                    <tr>
                                        <th class="bg-light">Username</th>
                                        <th class="bg-light">Score</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($con,"SELECT * FROM quiz_7");
                                        while($row = mysqli_fetch_array($result))
                                        {
                                        if($row['id'] == $_SESSION['id']){
                                        echo '<tr class="table-active">';
    ...
    <script src="assets/js/pages/leaderboards.js"></script>
