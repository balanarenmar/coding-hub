...
require_once 'quiz-6-answersheet.php';
if(isset($answer1)){
    //proceed
    }else{
                ...
                <div class="col-xl-8 col-md-6 mx-auto">
                    <div class="card">
                        <div class="card-body  text-center dial-chart">
                            <input type="text" class="dial" value="<?php echo "" . $totalCorrect . ""; ?>" data-width="150" data-height="200" data-fgColor="yellow" data-skin="tron" data-thickness=".2" data-angleOffset="180" disabled readonly="readonly" data-displayInput=false data-max="15" data-min="0">
                            <h4>You scored:</h4>
                            <h1 class="yellow-head"><?php echo "" . $totalCorrect . ""; ?> / 15</h1>
                        </div>
                    </div>
                    ...
                    <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-end">
                                <li class="page-item text-left m-r-50">
                                    <a class="page-link" href="6-strings.php" tabindex="-1">Back to Chapter 6</a>
                                </li>
                                ...
                                <li class="page-item text-right">
                                    <a class="page-link" href="7-file-input-output.php">Begin Chapter 7</a>
                                </li>
                            </ul>           
                    </nav>
                </footer>
