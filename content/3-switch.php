    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#!">switch... case</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card widget-statstic-card">
                        <div class="card-header">
                            <h4 style="color: #FC3;">C switch Statement</h4></div>
                        <div class="card-body">
                            <p class="card-text f-16 m-l-25">In this tutorial, you will learn to create the <span class="hl var">switch</span> statement in C programming with the help of an example.</p>
                            <p class="card-text f-16 m-l-25">The switch statement allows us to execute one code block among many alternatives.
                            <br><br>
                            You can do the same thing with the <span class="hl">if...else..if</span> ladder.<br> However, the syntax of the <span class="hl var">switch</span> statement is much easier to read and write.</p>
                            <br>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            <div class="card-header"><h3 class="yellow-head un-y ">Syntax of switch...case</h3></div>
                            <div class="card-body">
                                
                                    <div class="col-sm-8  mx-auto">
                                        <div class="snippet"><code>
                                            <pre class="code-line">switch (expression)</pre>
                                            <pre class="code-line">{</pre>
                                             <br>
                                            <pre class="code-line">case constant1: &ltstdio.h></pre>
                                            <pre class="code-line"><span class="comnt"> // statements</span></pre>
                                            <pre class="code-line">break;</pre>
                                             <br>
                                            <pre class="code-line">case constant2:</pre>
                                             <br>
                                            <pre class="code-line"><span class="comnt"> // statements</span></pre>
                                            <pre class="code-line"> break;</pre>
                                             <br>
                                            ...
                                            <pre class="code-line">.</pre>
                                            <pre class="code-line">.</pre>       
                                            <pre class="code-line">default:</pre>
                                            <pre class="code-line"><span class="comnt">// default statements</span></pre>
                                             <br>
                                            <pre class="code-line">}</pre>
                                            </code>
                                        </div>
                ...
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            <div class="card-header"><h3 class="yellow-head un-y ">How does the switch statement work? </h3></div>
                            <div class="card-body">
                            <p class="card-text f-16 m-l-50">The <span class="hl">expression</span> is evaluated once and compared with the values of each <span class="hl">case</span> label</p> <br>
                            <p class="card-text f-16 m-l-50">If there is a match, the corresponding statements after the matching label are executed. For example, if the value of the expression is equal to <span class="hl">constant2</span> , statements after <span class="hl">case constant2:</span> are executed until <span class="hl var">break</span> is encountered.</p> <br>
                            <p class="card-text f-16 m-l-50">If there is no match, the default statements are executed.</p>
                          </div>      
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            <div class="card-header"><h3 class="yellow-head un-y ">Example: Simple Calculator</h3></div>
                            <div class="card-body">
                                <div class="col-sm-8  mx-auto">
                                        <div class="snippet"><code>
                                            <pre class="code-line"><span class="comnt">// Program to create a simple calculator</span></pre>
                                            </code> 
                                            <pre class="code-line">#include &ltstdio.h></pre>
                                            </code> <br>
                                            <pre class="code-line"> int main() {</pre>
                                            </code>
                                            <pre class="code-line">char operator;</pre>
                                            </code> 
                                            <pre class="code-line">double n1, n2;</pre>
                                            </code> <br>
                                            <pre class="code-line">printf("Enter an operator (+, -, *, /): ");</pre>
                                            </code> 
                                            <pre class="code-line">scanf("%c", &operator);</pre>
                                            </code> 
                                            <pre class="code-line"> printf("Enter two operands: ");</pre>
                                            </code> 
                                            <pre class="code-line">switch(operator)</pre>
                                            </code> 
                                            <pre class="code-line">{</pre>
                                            </code> <br>
                                            <pre class="code-line"> case '+':</pre>
                                            </code>
                                            <pre class="code-line"> printf("%.1lf + %.1lf = %.1lf",n1, n2, n1+n2);</pre>
                                            </code> 
                                            <pre class="code-line">break;</pre>
                                            </code> <br>
                                            <pre class="code-line"> case '-':</pre>
                                            ...
                                            <pre class="code-line"><span class="comnt">// operator doesn't match any case constant +, -, *, /</span></pre>
                                            </code> 
                                            <pre class="code-line">default:</pre>
                                            </code> 
                                            <pre class="code-line">printf("Error! operator is not correct");</pre>
                                            </code> 
                                            <pre class="code-line">}</pre>
                                            </code> <br>
                ...
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="col-sm-8  mx-auto">
                                        <div class="snippet"><code>
                                            <pre class="code-line">Enter an operator (+, -, *,): -</pre>
                                            <pre class="code-line">Enter two operands: 32.5</pre>
                                            <pre class="code-line">12.4</pre>
                                            <pre class="code-line">32.5 - 12.4 = 20.1</pre>
                                            </code>
                                        </div> 
                                    </div>
                                        <p class="f-16">
                                        The <span class="hl var">-</span> operator entered by the user is stored in the <span class="hl var">operator</span> variable. And, two operands <span class="hl int">32.5</span> and <span class="hl int">12.4</span> are stored in variables <span class="hl var">n1</span> and <span class="hl var">n2</span> respectively</p>
                                </div>
                         </div>
                    </div>
            </div> <!-- end row-->
            ...
            <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-end">
                        <li class="page-item m-r-50">
                            <a class="page-link" href="3-if-else.php" tabindex="-1">Previous Lesson</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="3-while.php">Next Topic</a>
                        </li>
                    </ul>           
            </nav>
        </footer>
