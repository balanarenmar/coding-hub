        ...
        <div class="pcoded-content">
                ...
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><i class="feather icon-refresh-ccw"></i></li>
                                <li class="breadcrumb-item"><a href="#!">Functions</a></li>
                                <li class="breadcrumb-item"><a href="#!">Recursion</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card widget-statstic-card">
                        <div class="card-header">
                            <h4 style="color: #FC3;">C Recursion</h4>
                        </div>
                        <div class="card-body text-center">
                            ...
                            <i class="feather icon-refresh-ccw st-icon bg-c-blue"></i>
                        </div>
                    </div>
                </div>
            </div> <!--End row-->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                          <div class="card-header">
                              <h4 class="un-y yellow-head">How recursion works?</h4>
                          </div>
                          <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                        <img src="assets/images/video-lesson/hrw.jpg" alt="recursion img"width="100%" height="auto" style="max-width: 600px;">
                                        <br><br>
                                        <img src="assets/images/video-lesson/hdrw.jpg" alt="" width="100%" height="auto" style="max-width: 400px;">
                                    </div>
                                </div>
                                <br>
                              <p class="card-text f-16 m-l-50">The recursion continues until some condition is met to prevent it.</p>
                              <p class="card-text f-16 m-l-50">To prevent infinite recursion, if...else statement (or similar approach) can be used where one branch makes the recursive call, and other doesn't.</p>
                            </div>
                    </div>
                </div>
            </div><!--End row-->
               ...
               <div class="row">
                      <div class="col-sm-12">
                          <div class="card bg-dark">
                              <div class="card-header">
                                  <h4 class="un-y yellow-head">Example: Sum of Natural Numbers Using Recursion</h4>
                              </div>
                              <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                  ...
                                  <div class="row text-center">
                                    <div class="col-sm-12">
                                        <img src="assets/images/video-lesson/snnuro.jpg" alt="recursion img" width="100%" height="auto" style="max-width: 600px;">
                                        <br><br>
                                    </div>
                                  </div>
                                  <br><br>
                                 <p class="card-text f-16 m-l-50">Initially, the sum() is called from the main() function with number passed as an argument.</p>
                                  <p class="card-text f-16 m-l-50">Suppose, the value of n inside sum() is 3 initially. During the next function call, 2 is passed to the sum() function. This process continues until n is equal to 0.</p>
                                  <p class="card-text f-16 m-l-50">When n is equal to 0, the if condition fails and the else part is executed returning the sum of integers ultimately to the main() function.</p>
                                    <div class="row text-center">
                                        <div class="col-sm-12">
                                            <img src="assets/images/video-lesson/snnurs.jpg" alt="recursion img" width="100%" height="auto" style="max-width: 400px;">
                                            <br><br>
                                        </div>
                                    </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                  <div class="card">
                      ...
                      <div class="card-body">
                          <p class="card-text f-16 m-l-50">Recursion makes program elegant. However, if performance is vital, use loops instead as recursion is usually much slower.</p>
                            <br>
                        <p class="card-text f-16 m-l-50">That being said, recursion is an important concept. It is frequently used in data structure and algorithms. For example, it is common to use recursion in problems such as tree traversal.</p>
                            <br>
                         </div>
                      </div>
                  </div>
            ...
            <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-end">
                        <li class="page-item m-r-50">
                            <a class="page-link" href="4-types-user-defined.php" tabindex="-1">Previous Lesson</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="4-storage-class.php">Next Topic</a>
                        </li>
                    </ul>           
            </nav>
        </footer>
