...
<body class="background-img-5 container box-layout">
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#!">Standard Files</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card widget-statstic-card">
                        ...
                        <div class="card-body">
                            <p class="f-16">
                               In C, data must be input to, and output from a program through a file.</p>
                            <p class="f-16">
                               The <strong style="text-decoration:underline;">keyboard</strong> is considered as the <span class="text-primary">STANDARD INPUT FILE</span><br>
                               The <strong style="text-decoration:underline;">monitor</strong> is considered as the <span class="text-primary">STANDARD OUTPUT FILE</span></p>
                            <p class="f-16 m-l-30">
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark widget-visitor-card">
                            <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                        <img src="assets/images/video-lesson/standardio.png" width="80%">
                                    </div>
                                </div>
                                <p class="card-text f-16 text-center">Diagram of C formatted Input and Output</p>
         ...
         <div class="row">
          <div class="col-sm-12">
              <div class="card">
                  <div class="card-header">
                      <h4 class="un-y yellow-head">Advantages and Disadvantages of Recursion</h4>
                  </div>
                  <div class="card-body">
                      <p class="f-16">
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            <div class="card-header"><h3 class="yellow-head un-y ">Input / Output</h3></div>
                            <div class="card-body">
                                
                                <p class="card-text f-16 m-l-50">When we say <span class="text-info font-weight-bold">INPUT</span>, it means to feed some data into a program.<br>An input can be given in the form of a file or from the command line. C programming provides a set of built-in functions to read the given input and feed it to the program as per requirement.</p>
                                <p class="card-text f-16 m-l-50">When we say <span class="text-info font-weight-bold">OUTPUT</span>, it means to display some data on screen, printer, or in any file.<br>C programming provides a set of built-in functions to output the data on the computer screen as well as to save it in text or binary files.</p>

                                <br><hr><br>

                                <h4 class="m-b-20 hov-blue">The Standard Files</h4>
                                    <p class="card-text f-16 m-l-50">C programming treats all the devices as files. So devices such as the display are addressed in the same way as files and the following three files are automatically opened when a program executes to provide access to the keyboard and screen.</p>
                                    <br>
                                            ...
                                            <table class="table table-xs table-hover table-dark" border="0" >
                                                ...
                                                <tbody style="text-align: center; font-weight: bolder;">
                                                    <tr>
                                                        ...
                                                        <td><span class="hl">stdin</span></td>
                                                        <td>Keyboard</td>
                                                    </tr>   
                                                    <tr>
                                                        <td>Standard Output</td>
                                                        <td><span class="hl">stdout</span></td>
                                                        <td>Monitor / Screen</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Standard Error</td>
                                                        <td><span class="hl">stderr</span></td>
                                                        <td>Monitor / Screen</td>
                                                    </tr> 
                                                </tbody>
                                            </table>
                                    ...
                                    <br>
                                    <p class="card-text f-16 m-l-50">The file pointers are the means to access the file for reading and writing purpose. This section explains how to read values from the screen and how to print the result on the screen.</p>
                                    <p class="card-text f-16 m-l-50">You will learn more about the different kinds of built-in functions that utilize the standard input & output stream to gather and display data.</p>
            ...
            <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-end">
                        <li class="page-item m-r-50">
                            <a class="page-link" href="1-program-structure.php" tabindex="-1">Previous Lesson</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="2-getchar-putchar.php">Next Topic</a>
                        </li>
                    </ul>           
            </nav>
        </footer>
