...
require_once 'quiz-3-answersheet.php';
if(isset($answer1)){
    //proceed
    }else{
                    ...
                    <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-end">
                                <li class="page-item text-left m-r-50">
                                    <a class="page-link" href="3-if.php" tabindex="-1">Back to Chapter 3</a>
                                </li>
                                ...
                                <li class="page-item text-right">
                                    <a class="page-link" href="4-std-functions.php">Begin Chapter 4</a>
                                </li>
                            </ul>           
                    </nav>
                </footer>
