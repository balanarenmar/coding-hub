...
<body class="background-img-4 container box-layout">
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                ...
                <div class="col-sm-12">
                    <div class="card widget-statstic-card">
                        <div class="card-header">
                            <h4 style="color: #FC3;">QUIZ # 1 </h4>
                        </div>
                        <div class="card-body">
                            <p class="f-16">Test your knowledge about what you've learned in the past lessons of Chapter 1.</p>
                            <p class="f-16">The quiz contains 20 questions and there is no time limit.</p>
                            <p class="f-16">Topics included in this quiz focus about Syntax, ranging from key words, variables, data types, and operators</p>
            ...
            <!-- [ Main Content ] end -->
            <!-- [ Main Content ] start -->
            <form action="quiz-1-result.php" method="post" id="quiz">
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A set of alphabets, letters and some special characters.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required/>
                                        <label for="question-1-answers-A"><li> Escape Sequences</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                                        <label for="question-1-answers-B"><li> Keywords</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                                        <label for="question-1-answers-C"><li> Character Set</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" />
                                        <label for="question-1-answers-D"><li> Identifiers</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A symbol that operates on a value or a variable.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-A" value="A" required/>
                                        <label for="question-2-answers-A"><li> Literal</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
                                        <label for="question-2-answers-B"><li> Function</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                                        <label for="question-2-answers-C"><li> Constant</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-2-answers" id="question-2-answers-D" value="D" />
                                        <label for="question-2-answers-D"><li> Operator</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What does this symbol mean?</p>
                                <div style="display: flex; justify-content:center;">
                                    <img src="assets/images/next.png" class="mx-auto">
                                </div>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-A" value="A" required/>
                                        <label for="question-3-answers-A"><li> Greater than Operator</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                                        <label for="question-3-answers-B"><li> Shift Right</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                                        <label for="question-3-answers-C"><li> Next</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-3-answers" id="question-3-answers-D" value="D" />
                                        <label for="question-3-answers-D"><li> Bitwise Exclusive Or</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-sm-8  mx-auto">
                                        <div class="snippet"><code>
                                            ...
                                            <pre class="code-line">   c = a-b;</pre>
                                            <pre class="code-line">   c++;</pre>
                                            <pre class="code-line">   c+=b;</pre>
                                ...
                                <ol class="choices">
                                    <div class="choice">
                                        ...
                                        <label for="question-4-answers-A"><li> 1</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-B" value="B" />
                                        <label for="question-4-answers-B"><li> 14</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
                                        <label for="question-4-answers-C"><li> 4</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-4-answers" id="question-4-answers-D" value="D" />
                                        <label for="question-4-answers-D"><li> 10</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A container (storage area) to hold data.</p>
                                <ol class="choices">
                                    <div class="choice">
                                    ...
                                    <div class="choice">
                                        ...
                                        <label for="question-5-answers-B"><li> Variable</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                                        <label for="question-5-answers-C"><li> Data type</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-5-answers" id="question-5-answers-D" value="D" />
                                        <label for="question-5-answers-D"><li> Literal</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ol class="choices">
                                    <div class="choice">
                                        ...
                                        <label for="question-6-answers-A"><li> 3</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-B" value="B" />
                                        <label for="question-6-answers-B"><li> 2</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-C" value="C" />
                                        <label for="question-6-answers-C"><li> 1</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-6-answers" id="question-6-answers-D" value="D" />
                                        <label for="question-6-answers-D"><li> 0</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">It is predefined, reserved words used in programming that have special meanings to the compiler.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-A" value="A" required/>
                                        <label for="question-7-answers-A"><li> Identifier</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                                        <label for="question-7-answers-B"><li> Data types</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" />
                                        <label for="question-7-answers-C"><li> Key Words</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-7-answers" id="question-7-answers-D" value="D" />
                                        <label for="question-7-answers-D"><li> Special Characters</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">Determines the type and size associated for variables.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-A" value="A" required/>
                                        <label for="question-8-answers-A"><li> Operator</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                                        <label for="question-8-answers-B"><li> Data type</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                                        <label for="question-8-answers-C"><li> Variable</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-8-answers" id="question-8-answers-D" value="D" />
                                        <label for="question-8-answers-D"><li> Identifier</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">The name given to entities such as variables, functions, structures etc.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-A" value="A" required/>
                                        <label for="question-9-answers-A"><li> Identifiers</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                                        <label for="question-9-answers-B"><li> Data type</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" />
                                        <label for="question-9-answers-C"><li> Keywords</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-9-answers" id="question-9-answers-D" value="D" />
                                        <label for="question-9-answers-D"><li> Special Characters</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A variable whose value cannot be changed.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-A" value="A" required/>
                                        <label for="question-10-answers-A"><li> Escape Sequence</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-B" value="B" />
                                        <label for="question-10-answers-B"><li> Special Character</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-C" value="C" />
                                        <label for="question-10-answers-C"><li> Literal</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-10-answers" id="question-10-answers-D" value="D" />
                                        <label for="question-10-answers-D"><li> Constant</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A numeric literal that has either a fractional form or an exponent form.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-14-answers" id="question-14-answers-A" value="A" required/>
                                        <label for="question-14-answers-A"><li> Double</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-14-answers" id="question-14-answers-B" value="B" />
                                        <label for="question-14-answers-B"><li> Integer</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-14-answers" id="question-14-answers-C" value="C" />
                                        <label for="question-14-answers-C"><li> Literal</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-14-answers" id="question-14-answers-D" value="D" />
                                        <label for="question-14-answers-D"><li> Floating-point Literal</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">A software for building applications that combines common developer tools into a single graphical user interface.</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-16-answers" id="question-16-answers-A" value="A" required/>
                                        <label for="question-16-answers-A"><li> Compiler</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-16-answers" id="question-16-answers-B" value="B" />
                                        <label for="question-16-answers-B"><li> IDE</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-16-answers" id="question-16-answers-C" value="C" />
                                        <label for="question-16-answers-C"><li> IDK</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-16-answers" id="question-16-answers-D" value="D" />
                                        <label for="question-16-answers-D"><li> Source code editor</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">What does this symbol do?</p>
                                <div style="display: flex; justify-content:center;">
                                    <span class="opp f-50">%</span>
                                </div>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-A" value="A" required/>
                                        <label for="question-18-answers-A"><li> Divides</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-B" value="B" />
                                        <label for="question-18-answers-B"><li> Solves for the remainder</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-C" value="C" />
                                        <label for="question-18-answers-C"><li> Modulo operator</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-18-answers" id="question-18-answers-D" value="D" />
                                        <label for="question-18-answers-D"><li> Find the percentage</li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card text-white bg-dark ">
                            ...
                            <div class="card-body">
                                <p class="question">An unsigned integer can hold what range of values?</p>
                                <ol class="choices">
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-A" value="A" required/>
                                        <label for="question-20-answers-A"><li> 0 to 2<sup>31</sup></li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-B" value="B" />
                                        <label for="question-20-answers-B"><li> -2<sup>31 to 2<sup>31</sup>-1</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-C" value="C" />
                                        <label for="question-20-answers-C"><li> 0 to 2<sup>31</sup>-1</li></label>
                                    </div>
                                    <div class="choice">
                                        <input type="radio" name="question-20-answers" id="question-20-answers-D" value="D" />
                                        <label for="question-20-answers-D"><li> -2<sup>31 to 2<sup>31</sup></li></label>
                                    </div>
                                </ol>
                            </div>
                        </div>
