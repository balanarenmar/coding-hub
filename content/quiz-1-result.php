...
require_once 'quiz-1-answersheet.php';
if(isset($answer1)){
    //proceed
    }else{
                    ...
                    <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-end">
                                <li class="page-item text-left m-r-50">
                                    <a class="page-link" href="1-data-types.html" tabindex="-1">Back to Chapter 1</a>
                                </li>
                                ...
                                <li class="page-item text-right">
                                    <a class="page-link" href="2-standard-files.php">Begin Chapter 2</a>
                                </li>
                            </ul>           
                    </nav>
                </footer>
