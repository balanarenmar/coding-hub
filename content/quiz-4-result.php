...
require_once 'quiz-4-answersheet.php';
if(isset($answer1)){
    //proceed
    }else{
                    ...
                    <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-end">
                                <li class="page-item text-left m-r-50">
                                    <a class="page-link" href="4-std-functions.php" tabindex="-1">Back to Chapter 4</a>
                                </li>
                                ...
                                <li class="page-item text-right">
                                    <a class="page-link" href="5-arrays.php">Begin Chapter 5</a>
                                </li>
                            </ul>           
                    </nav>
                </footer>
